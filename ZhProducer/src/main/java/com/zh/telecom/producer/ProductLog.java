package com.zh.telecom.producer;
...
public class ProductLog {
     ...
     * 数据形式对应字段：caller,callee,buildTime,duration
     * @return
     */
    public String product(){
        try {
            ...
            //1. 取得主叫电话号码
            int callerIndex = (int) (Math.random() * phoneList.size()); //电话号码随机索引
            ...
            String duration = df.format((int) (30 * 60 * Math.random())); //30分钟*随机数
    ...
    /**
     * 打包运行：java -cp BigTelecom.jar com.zh.telecom.producer.ProductLog
     */
    public static void main(String[] args) throws InterruptedException {
//        args = new String[]{"D:\\calllog.csv"};
        if (args == null || args.length <= 0) {
            System.out.println("没有文件目录");
            return;
        }
